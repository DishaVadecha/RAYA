        ...
        <section class="ftco-section ftco-no-pt ftco-no-pb py-5 bg-light">
            <div class="container py-4">
                <div class="row d-flex justify-content-center py-5" style="padding-bottom: 0rem !important; padding-top: 2rem !important">
                    <h2 style="color:#82ae46" class="inline">Cart</h2>
                </div>
                <div class="row d-flex justify-content-center py-5">
                    <div class="col-md-6 d-flex align-items-center">
                        <form action="check.php" class="subscribe-form" method="post" name="f1" id="f1" enctype="multipart/form-data">
                            
                            <div class="form-group d-flex">
                                <input type="text" class="form-control" placeholder="Name of Product" disabled>
                                <input type="text" class="form-control" name="pname" id="pname" value="<?php echo $name; ?>" readonly>
                            </div>
                            
                            <div class="form-group d-flex">
                                <input type="text" class="form-control" placeholder="Type of Product" disabled>
                            ...
                            <div class="form-group d-flex">
                                ...
                                <input type="text" class="form-control" name="price" id="price" value="<?php echo $price; ?>" readonly>
                            </div>
                            
                            <div class="form-group d-flex">
                                <input type="text" class="form-control" placeholder="Image" disabled>
                                <a href="" class="img-prod inactiveLink"><img class="img-fluid img-check" src="<?php echo $image?>" alt="Floral">
                                </a>
                                <input type="hidden" name="himage" value="<?php echo $image?>">
                            </div>
                            ...
                            <div class="form-group d-flex">
                            	...
                            	<input type="submit" name = "sub" id="sub" value="Pay" class="submit px-3 justify-content-center" style="padding: 0 3.5rem !important">
