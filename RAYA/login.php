        ...
        <section class="ftco-section ftco-no-pt ftco-no-pb py-5 bg-light">
            <div class="container py-4">
                <div class="row d-flex justify-content-center py-5" style="padding-bottom: 0rem !important; padding-top: 2rem !important">
                    <h2 style="color:#82ae46" class="inline">Login</h2>
                </div>
                <div class="row d-flex justify-content-center py-5">
                    <div class="col-md-6 d-flex align-items-center">
                        <form action="logincheck.php" class="subscribe-form" method="post">
                            ...
                            <div class="form-group d-flex">
                            	...
                            	<input type="submit" value="Submit" class="submit px-3 justify-content-center" style="padding: 0 3rem !important">
