        ...
        <section class="ftco-section ftco-no-pt ftco-no-pb py-5 bg-light">
            <div class="container py-4">
                <div class="row d-flex justify-content-center py-5" style="padding-bottom: 0rem !important; padding-top: 2rem !important">
                    <h2 style="color:#82ae46" class="inline">Register</h2>
                </div>
                <div class="row d-flex justify-content-center py-5">
                    <div class="col-md-6 d-flex align-items-center">
                        <form action="registercheck.php" class="subscribe-form" method="post">
                            ...
                            <div class="form-group d-flex">
                                <input type="text" class="form-control" placeholder="Email ID" name="eid" id="eid">
                            </div>
                            <div class="form-group d-flex">
                                <input type="password" class="form-control" placeholder="Password" name="pwd" id="pwd">
                            </div>
                            <div class="form-group d-flex">
                                <input type="text" class="form-control" placeholder="&#8377; 2000" name="price" id="price" disabled>
                            </div>
                            <div class="form-group d-flex">
                            	<input type="text" class="form-control" disabled style="height: 20px !important;">
                            	<input type="submit" value="Submit" id ="sub" name="sub" class="submit px-3 justify-content-center" style="padding: 0 3rem !important">
